    ...
    didOpen: () => {
      ...
      newContact._recompute = function () {
        ...
        if (hasCom && dt) {
          ...
          box.value = `This is to confirm that I scheduled you for a ${len} minute ${plat} ${type} on ${date}.  To view or cancel it: https://4lsg.com/m/{{appts.appt_manage_token|default:}}`;
        }
      };
    },
  ...
  function recompute() {
    ...
    if (E('naConfirmMsg')) {
      ...
      if (hasCom && dt) {
        ...
        E('naConfirmMsg').value = `This is to confirm that I scheduled you for a ${len} minute ${plat} ${type} on ${date}.  To view or cancel it: https://4lsg.com/m/{{appts.appt_manage_token|default:}}`;
      }
    }
  }
