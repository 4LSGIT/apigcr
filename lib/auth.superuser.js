...
// it as X-SU-Elevation. Rider B of ref/archive/ORIGIN_SEPARATION_ROLLOUT.md.
//
...
const RATE_BY_TOOL = {
  db_console: 120,
  api_tester: 60,
  // Browsing scratch is bursty the same way the DB console is: one list, then
  // a GET per key as you click down an audit. 30 runs out mid-review.
  scratch: 60,
