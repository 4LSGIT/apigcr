  ...
  cases: {
    ...
    columns: {
      ...
      case_stage: {
        ...
        note:
          "CURRENT stage only — there is no history. Live distribution " +
          "(2026-08-08): Open 711, Closed 303, Filed 45, Pending 15. Note " +
          "'Concluded' is a legal enum value with zero rows.",
      },
      ...
      case_dropbox: { type: "varchar(255)", note: "URL of the case's Dropbox folder. 1006/1074 (94%). A link column for views, not a grouping dimension." },
