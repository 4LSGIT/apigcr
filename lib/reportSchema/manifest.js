...
const TABLES = {
  ...
  cases: {
    note:
      ...
      "individual custom fields become reportable as their own named columns " +
      "in a later release.",
    columns: {
  ...
  contacts: {
    note:
      ...
      "report, not even via a JSON path; individual custom fields become reportable as their own named columns " +
      "in a later release.",
    columns: {
