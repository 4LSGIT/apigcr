...
// ─────────────────────────────────────────────────────────────
   ...
   *   event_type        {string?}
   *   event_link_type   {string?}  – 'case' | 'contact' (omit for internal)
   *   event_link_id     {string?}  – case_id or contact_id
...
internalFunctions.create_event.__meta = {
  ...
  params: [
    ...
    { name: 'event_link_type', type: 'enum', required: false,
      enum: ['case', 'contact'],
      description: 'Omit for an internal/unlinked event.' },
    { name: 'event_link_id', type: 'string', required: false, placeholderAllowed: true,
      description: 'case_id or contact_id.', example: '{{caseId}}' },
...
internalFunctions.update_event.__meta = {
  ...
  params: [
    ...
    { name: 'fields', type: 'object', required: false,
      description: 'Column → value pairs. Allowed: event_type, event_link_type, event_link_id, event_title, event_date, event_time, event_all_day, event_length, event_location, event_link, event_note, event_status, event_calendar_id. At least one of fields or reminder is required.',
...
internalFunctions.get_events.__meta = {
  ...
  params: [
    { name: 'link_type', type: 'enum', required: false, enum: ['case', 'contact'] },
    { name: 'link_id', type: 'string', required: false, placeholderAllowed: true },
    { name: 'status', type: 'string', required: false,
