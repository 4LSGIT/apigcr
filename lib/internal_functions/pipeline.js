...
fns.advance_stage = async (params, db) => {
  ...
  return {
    ...
    output: {
      ...
      noop: result.noop,
      skipped: result.skipped === true,
      from: result.skipped === true ? (result.from == null ? null : result.from) : undefined,
