...
// INSIDE the advance request, so this shares the 120s in-request ceiling the
// webhook step already uses (routes/workflows.js MAX_TIMEOUT_MS_WF,
// lib/webhookExecutor.js MAX_TIMEOUT_MS) rather than inventing a new number.
...
const SAVE_URL_MAX_TIMEOUT_MS = 120000;
 ...
 *   timeout_ms    {number?}  — poll ceiling, default 25000, max 120000
 *   credential_id {number?}
 *
 * example config:
 *   {
