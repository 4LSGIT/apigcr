 ...
 *       autocommit pool; the sole withTransaction in those modules is
 *       hookService.duplicateHook, a CRUD copy off the dispatch path. The
 *       row is committed before this function is awaited.
