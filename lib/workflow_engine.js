...
function resolvePlaceholders(template, context) {
  if (typeof template === 'string') {
    ...
    // placeholder (optionally surrounded by whitespace), return the resolved
    // value directly to preserve non-string types (arrays, objects, numbers,
    // booleans). Without this, String.prototype.replace coerces arrays like
    // MMS attachments to "[object Object],[object Object]". Mixed-content or
    // multi-placeholder strings continue through the regex replace path
    // below, which intentionally string-coerces.
