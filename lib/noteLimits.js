...
//
// Nobody was told. Those tails are unrecoverable. Every notes column here is
...
//
// events.event_note joined the set on 2026-08-20 (W2), when checklistView.html
// began surfacing it as an editable 10,000-character pinned card. Before that
// its only writers were newEventDialog and the court pipeline, and nothing
// checked its length at all.
//
...
const NOTE_COLUMNS = new Set([
  ...
  'event_note',       // events    — TEXT (W2: surfaced as a pinned native card)
