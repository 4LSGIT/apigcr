 ...
 *                                 error?, result? }]
 * T6/F-3: a failed transform emits a SYNTHETIC entry
 *   { status:'failed', rule_id, rule_action_id:null,
 *     action_type:'transform', error } — rule_action_id is null there, so
 * the summary line renders "action null (transform)". Cosmetic; the
 * action_type makes it unambiguous.
 */
